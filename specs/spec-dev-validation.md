...
| AI review (Unified AI Review harness) | `req-cicd-ai-review-ensemble` | Per-PR (advisory comment on every PR incl. forks) | Advisory (non-blocking by design — Phase 1 of req-cicd-ai-review-graduation) | `.github/workflows/ai-review-capture.yml` + `ai-review.yml` shims → SHA-pinned `unified-ai-review` reusable workflows |
