...
# code is the installed PEP 420 namespace package tap_plugin.lotr (tap_plugin/lotr/).
# This exists only so pytest names this project dir's tests fully-qualified as
# plugins.lotr.tests.* during the monorepo transition, avoiding the orphan-tests
