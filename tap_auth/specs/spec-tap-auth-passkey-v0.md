...
| req-tap-auth-passkey-dev-bootstrap | [Dev Bootstrap (Spawn Passkey Replay)](#dev-bootstrap-spawn-passkey-replay) | Implemented | Register-once / replay-forever; `--import-dev-passkey`; additive to the spawn password bridge in v0 (full replacement rides password retirement); dev/test-only, fails closed in prod |
